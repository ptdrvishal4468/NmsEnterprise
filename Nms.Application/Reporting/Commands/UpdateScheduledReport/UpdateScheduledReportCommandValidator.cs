...
public class UpdateScheduledReportCommandValidator : AbstractValidator<UpdateScheduledReportCommand>
{
    public UpdateScheduledReportCommandValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Scheduled report ID is required.");
