...
{
    public UpdateCustomerContactCommandValidator(IUnitOfWork unitOfWork)
    {
        ...
        RuleFor(x => x.Dto.Email)
            ...
            .MustAsync(async (cmd, email, ct) => !await unitOfWork.CustomerContacts.EmailExistsInCustomerAsync(cmd.CustomerId, email.Trim().ToLowerInvariant(), cmd.ContactId, ct))
