        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SnmpPort = table.Column<int>(type: "int", nullable: false, defaultValue: 161),
                    SnmpV3User = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SnmpV3AuthKeyEncrypted = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SnmpV3PrivKeyEncrypted = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceMetricsRaw_TimestampUtc",
                table: "DeviceMetricsRaw",
                column: "TimestampUtc")
