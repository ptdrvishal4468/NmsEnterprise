...
{
    /// <inheritdoc />
    public partial class AddSiteAndLocationManagementTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeightInUnits = table.Column<int>(type: "int", nullable: false),
                    WidthInInches = table.Column<int>(type: "int", nullable: true),
                    DepthInMm = table.Column<int>(type: "int", nullable: true),
                    MaxPowerWatts = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buildings_TenantId_IsActive",
                table: "Buildings",
                columns: new[] { "TenantId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Buildings_TenantId_SiteId",
                table: "Buildings",
                columns: new[] { "TenantId", "SiteId" });

            migrationBuilder.CreateIndex(
                name: "IX_Buildings_TenantId_SiteId_Code",
                table: "Buildings",
                columns: new[] { "TenantId", "SiteId", "Code" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Floors_TenantId_BuildingId",
                table: "Floors",
                columns: new[] { "TenantId", "BuildingId" });

            migrationBuilder.CreateIndex(
                name: "IX_Floors_TenantId_BuildingId_FloorNumber",
                table: "Floors",
                columns: new[] { "TenantId", "BuildingId", "FloorNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Floors_TenantId_IsActive",
                table: "Floors",
                columns: new[] { "TenantId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Racks_TenantId_IsActive",
                table: "Racks",
                columns: new[] { "TenantId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_Racks_TenantId_RoomId",
                table: "Racks",
                columns: new[] { "TenantId", "RoomId" });

            migrationBuilder.CreateIndex(
                name: "IX_Racks_TenantId_RoomId_Identifier",
                table: "Racks",
                columns: new[] { "TenantId", "RoomId", "Identifier" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_TenantId_FloorId",
                table: "Rooms",
                columns: new[] { "TenantId", "FloorId" });

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_TenantId_FloorId_Code",
                table: "Rooms",
                columns: new[] { "TenantId", "FloorId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Rooms_TenantId_IsActive",
                table: "Rooms",
                columns: new[] { "TenantId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sites_TenantId_IsActive",
                table: "Sites",
                columns: new[] { "TenantId", "IsActive" });
